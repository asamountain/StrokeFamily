...
export const T = {
  en: {
    langToggle: '한국어',
    nav: { brand: 'StrokeFamily', home: 'Home', brain: 'Brain Atlas', heroes: 'Voices of Hope', wellbeing: 'Caregiver Wellbeing', iot: 'Smart Home Tech', builder: 'Build with Purpose', resources: 'Local Resources', community: 'Community', survey: 'Share Feedback' },
    home: {
  ...
  ko: {
    langToggle: 'English',
    nav: { brand: 'StrokeFamily', home: '홈', brain: '뇌 지도', heroes: '희망의 목소리', wellbeing: '간병인 웰빙', iot: '스마트 홈 기술', builder: '목적 있는 제작', resources: '지역 자원', community: '커뮤니티', survey: '의견 보내기' },
    home: {
      location: 'Wauwatosa, Wisconsin',
